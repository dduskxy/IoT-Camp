  ...
  const slides = [
    {
      ...
      text: "พร้อมที่จะก้าวเข้าสู่โลกของนวัตกรรมหรือยัง?"
    },
    {
      title: "คำถามสำคัญสำหรับการเริ่มต้น",
      highlight: "\"ทำไมเทคโนโลยี IoT จึงมีความสำคัญ?\"",
      text: "และเป้าหมายของการอบรมในครั้งนี้คืออะไร?"
    },
    {
      title: "ในยุคดิจิทัลปัจจุบัน",
      highlight: "Internet of Things (IoT)",
      text: "ได้ก้าวเข้ามาเป็นส่วนสำคัญในการขับเคลื่อนวิถีชีวิตและระบบอุตสาหกรรมในทุกมิติ"
    },
    {
      title: "อุปกรณ์และระบบต่างๆ ถูกเชื่อมโยงเข้าด้วยกัน",
      highlight: "ผ่านเครือข่ายอินเทอร์เน็ต",
      text: "ตั้งแต่ระบบบ้านอัจฉริยะ (Smart Home) การเกษตรแม่นยำสูง ไปจนถึงนวัตกรรมทางการแพทย์"
    },
    {
      title: "กิจกรรมในค่ายครั้งนี้ มุ่งเน้นไปที่",
      highlight: "การเรียนรู้ผ่านการ \"ลงมือปฏิบัติจริง\"",
      text: "ผู้เข้าร่วมจะได้ทดลองต่อวงจรอิเล็กทรอนิกส์และพัฒนาชุดคำสั่งด้วยตนเอง"
    },
    {
      title: "เพื่อสร้างความเข้าใจอย่างลึกซึ้ง",
      highlight: "ถึงกลไกการทำงานของเทคโนโลยี",
      text: "และเสริมสร้างศักยภาพในการเป็นนักพัฒนาโซลูชันในอนาคต"
    },
    {
      title: "เทคโนโลยีไม่ได้มีไว้เพื่อให้เราเป็นเพียงผู้ใช้งาน",
      highlight: "แต่เพื่อเสริมสร้างให้เราเป็น \"ผู้สร้างสรรค์นวัตกรรม\"",
      text: "ขอให้ทุกท่านเก็บเกี่ยวความรู้และสนุกกับกิจกรรมในค่ายครั้งนี้นะครับ!"
    }
  ];
