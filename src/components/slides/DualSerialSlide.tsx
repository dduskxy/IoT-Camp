...
export function DualSerialSlide() {
  ...
  return (
    <div className="flex flex-col h-full w-full p-4 md:p-6 text-white bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 shadow-[0_0_40px_rgba(59,130,246,0.2)]">
